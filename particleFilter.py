...
class robot:
    ...
    def __init__(self, length = 20.0):
        ...
        self.bearing_noise  = 0.1 # initialize bearing noise to zero
    ...
    def move(self, motion): # Do not change the name of this function
                ...
                # ADD CODE HERE
        alpha = motion[0]+random.gauss(0, self.steering_noise)
        ...
        #print distance
        length = self.length
        beta = (distance/length) * tan(alpha)
        #print length
        #print beta
    ...
    def sense(self): #do not change the name of this function
        ...
        for item in landmarks:
            ...
            orientation = self.orientation+random.gauss(0, self.bearing_noise)
            #orientation = self.orientation
            Z.append(atan2(((self.y-item[0])),((self.x-item[1])))+pi-orientation)
